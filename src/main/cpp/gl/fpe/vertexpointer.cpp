...
void glVertexPointer(GLint size,
    ...
    g_glstate.vertexpointer_array.pointers[vp2idx(GL_VERTEX_ARRAY)] = {
            .size = size,
    ...
    g_glstate.vertexpointer_array.dirty = true;
}
...
void glColorPointer(GLint size, GLenum type, GLsizei stride, const GLvoid *pointer) {
    ...
    g_glstate.vertexpointer_array.pointers[vp2idx(GL_COLOR_ARRAY)] = {
            .size = size,
...
void glIndexPointer(GLenum type, GLsizei stride, const GLvoid *pointer ) {
    ...
    g_glstate.vertexpointer_array.pointers[vp2idx(GL_INDEX_ARRAY)] = {
            .size = 1,
...
void glEnableClientState(GLenum cap) {
    ...
    g_glstate.vertexpointer_array.enabled_pointers |= mask;
    LOG_D("Enabled Ptr: 0x%x", g_glstate.vertexpointer_array.enabled_pointers)
    g_glstate.vertexpointer_array.dirty = true;
}
