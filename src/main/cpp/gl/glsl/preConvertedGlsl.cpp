...
FogParameters Fog = FogParameters(FogColor, FogDensity, FogStart, FogEnd, 1.0f / (FogEnd - FogStart));
...
FogParameters Fog = FogParameters(FogColor, FogDensity, FogStart, FogEnd, 1.0 / (FogEnd - FogStart));
